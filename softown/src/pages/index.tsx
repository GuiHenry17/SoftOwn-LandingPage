  ...
  return (
    <main>
      ...
      <div className="data-protect-container">
        <div className="desc-text-container">
          <h2>Proteja seus dados e garanta a conformidade com as normas jurídicas.</h2>
          <div className="text-list">
            {[
              {
      ...
      <div className="data-flux-container">
        ...
        <div className="desc-text-container">
          ...
          <span id='flux-desc'>Explica pro Product Onwer que o módulo de recursão paralela corrigiu o bug do JSON compilado a partir de proto-buffers.</span>
          <div className="text-list">
            {[
              {
      ...
      <div className="paper-container">
        <div className="desc-text-container-paper">
          <h2>Elimine todos papéis do seu escritório.</h2>
          <div className="text-list">
            {[
              {
      ...
      <div className="team-contact">
        <div className="contact-text">
          ...
          <h2>Entre em contato com nosso time e agende uma desmontração gratuita!</h2>
        </div>
        <div className="contact-button">
          <button>Fale com nosso time de vendas
            <Image
              src="/assets/wpp.png"
    ...
    <div className="plans-grid">
        <div className="plan-card" style={estiloBorda(0)}>
          <h3>Inicial</h3>
          <p className="price">R$30 <span>/mês</span></p>
          <ul>
            <li>Lorem ipsum <strong>sit consectetur.</strong></li>
            <li>Praesent <strong>luctus facilisis.</strong></li>
            <li>Aenean lobortis velit a <strong>suscipit.</strong></li>
            <li>Nulla consequat <strong>sem sit amet.</strong></li>
          </ul>
          <button onClick={() => selecionarPlano(0)}>Selecionar este plano</button>
        </div>

        <div className="plan-card popular" style={estiloBorda(1)}>
          <div className="badge">Plano mais contratado</div>
          <h3>Intermediário</h3>
          <p className="price">R$100 <span>/mês</span></p>
          <ul>
            <li>Lorem ipsum <strong>sit consectetur.</strong></li>
            <li>Praesent <strong>luctus facilisis.</strong></li>
            <li>Aenean lobortis velit a <strong>suscipit.</strong></li>
          ...
          <button onClick={() => selecionarPlano(1)}>Selecionar este plano</button>
        </div>

        <div className="plan-card" style={estiloBorda(2)}>
          <h3>Completo</h3>
          <p className="price">R$300 <span>/mês</span></p>
          <ul>
            <li>Lorem ipsum <strong>sit consectetur.</strong></li>
            <li>Praesent <strong>luctus facilisis.</strong></li>
            <li>Aenean lobortis velit a <strong>suscipit.</strong></li>
          ...
          <button onClick={() => selecionarPlano(2)}>Selecionar este plano</button>
        </div>
      </div>
      ...
      <div className="faq-item">
        ...
        {isOpen && (
          <p className="faq-answer">
            ...
            feugiat porttitor suscipit. Proin congue tristique erat quis
            elementum.
          </p>
        )}
      </div>
    ...
    <div id='difbg' className="team-contact">
        <div className="contact-text">
          ...
          <h2>Descubra como nossa plataforma pode transformar seu escritório.</h2>
        </div>
        <div className="contact-button">
          <button>Fale com nosso time de vendas
            <Image
